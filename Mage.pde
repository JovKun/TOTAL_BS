class Mage extends Character {
  ...
  public Mage(int characterX, int characterY, TOTAL_BS gameObject, int player) {
    super(5, 1, 1, "mage_standing.v2.png", "mage_shooting.v2.png", "mage_running.v2.png", "mage_jumping.v2.png", "mage_dead.v2.png", true, characterX, characterY, 0, 0, gameObject, player);
